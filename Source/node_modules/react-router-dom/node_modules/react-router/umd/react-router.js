(function (global, factory) {
  ...
  */
  ...
  function regexpToRegexp (path, keys) {
    // Use a negative lookahead to match only capturing usergroups.
    var usergroups = path.source.match(/\((?!\?)/g);
  ...
  function tokensToRegExp (tokens, keys, options) {
    ...
    if (end) {
      ...
      // In non-ending mode, we need the capturing usergroups to match as much as
