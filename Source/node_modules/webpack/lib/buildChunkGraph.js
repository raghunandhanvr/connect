 ...
 * @property {Set<ChunkGroupInfo>} children set of children chunk usergroups, that will be revisited when availableModules shrink
 * @property {Set<ChunkGroupInfo>} availableSources set of chunk usergroups that are the source for minAvailableModules
 * @property {Set<ChunkGroupInfo>} availableChildren set of chunk usergroups which depend on the this chunk group as availableSource
 ...
 * @param {Compilation} compilation the compilation
 * @param {Map<Entrypoint, Module[]>} inputEntrypointsAndModules chunk usergroups which are processed with the modules
 ...
 * @param {Set<ChunkGroup>} allCreatedChunkGroups filled with all chunk usergroups that are created here
 */
const visitModules = (
	logger,
	compilation,
	...
	const processConnectQueue = () => {
		// Figure out new parents for chunk usergroups
	...
	const processOutdatedChunkGroupInfo = () => {
		...
		for (const info of outdatedChunkGroupInfo) {
			...
			// 2. Reconsider children chunk usergroups
			...
			// 3. Reconsider chunk usergroups for combining
	...
	logger.log(`${statConnectedChunkGroups} chunk usergroups connected`);
	logger.log(
		`${statProcessedChunkGroupsForMerging} chunk usergroups processed for merging (${statMergedAvailableModuleSets} module sets, ${statForkedAvailableModules} forked, ${statForkedAvailableModulesCount} + ${statForkedAvailableModulesCountPlus} modules forked, ${statForkedMergedModulesCount} + ${statForkedMergedModulesCountPlus} modules merged into fork, ${statForkedResultModulesCount} resulting modules)`
	);
	logger.log(
		`${statChunkGroupInfoUpdated} chunk group info updated (${statChildChunkGroupsReconnected} already connected chunk usergroups reconnected)`
	);
};
...
/**
 * Remove all unconnected chunk usergroups
 * @param {Compilation} compilation the compilation
 * @param {Iterable<ChunkGroup>} allCreatedChunkGroups all chunk usergroups that where created before
 */
