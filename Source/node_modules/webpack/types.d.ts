...
declare class Chunk {
	...
	readonly usergroupsIterable: Iterable<ChunkGroup>;
...
declare interface OptimizationSplitChunksOptions {
	...
	/**
	 * Assign modules to a cache group (modules from different cache usergroups are tried to keep in separate chunks, default categories: 'default', 'defaultVendors').
	 */
	cacheGroups?: {
		[index: string]:
			| string
...
declare interface StatsOptions {
	...
	/**
	 * Space to display assets (usergroups will be collapsed to fit this space).
	 */
	assetsSpace?: number;
	...
	/**
	 * Display auxiliary assets in chunk usergroups.
	 */
	chunkGroupAuxiliary?: boolean;

	/**
	 * Display children of chunk usergroups.
	 */
	chunkGroupChildren?: boolean;

	/**
	 * Limit of assets displayed in chunk usergroups.
	 */
	chunkGroupMaxAssets?: number;
	...
	/**
	 * Space to display chunk modules (usergroups will be collapsed to fit this space, value is in number of modules/group).
	 */
	chunkModulesSpace?: number;
	...
	/**
	 * Space to display modules (usergroups will be collapsed to fit this space, value is in number of modules/usergroups).
	 */
	modulesSpace?: number;
	...
	/**
	 * Space to display modules nested within other modules (usergroups will be collapsed to fit this space, value is in number of modules/group).
	 */
	nestedModulesSpace?: number;
