...
ArgumentParser.prototype.addSubparsers = function (options) {
  ...
  if (!options.prog) {
    ...
    var usergroups = this._mutuallyExclusiveGroups;
    formatter.addUsage(this.usage, positionals, usergroups, '');
...
ArgumentParser.prototype._parseKnownArgs = function (argStrings, namespace) {
  ...
  // of two different mutually exclusive usergroups.
  ...
  // make sure all required usergroups have one option present
...
ArgumentParser.prototype.formatHelp = function () {
  ...
  // positionals, optionals and user-defined usergroups
