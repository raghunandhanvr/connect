...
function Yargs (processArgs, cwd, parentRequire) {
  ...
  self.resetOptions = self.reset = function resetOptions (aliases) {
    ...
    // preserve all usergroups not set to local.
    preservedGroups = Object.keys(usergroups).reduce((acc, groupName) => {
  ...
  self.group = function group (opts, groupName) {
    ...
    if (preservedGroups[groupName]) {
      // we now only need to track this group name in usergroups.
  ...
  // combine explicit and preserved usergroups. explicit usergroups should be first
