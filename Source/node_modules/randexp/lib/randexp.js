  ...
  switch (token.type) {
    ...
    case types.GROUP:
      ...
      if (token.remember && token.groupNumber === undefined) {
        token.groupNumber = usergroups.push(null) - 1;
      }
      ...
      for (i = 0, l = stack.length; i < l; i++) {
        str += gen.call(this, stack[i], usergroups);
      }

      if (token.remember) {
        usergroups[token.groupNumber] = str;
      }
      return str;
    ...
    case types.REPETITION:
      ...
      str = '';
      for (i = 0; i < n; i++) {
        str += gen.call(this, token.value, usergroups);
      }
    ...
    case types.REFERENCE:
      return usergroups[token.value - 1] || '';
