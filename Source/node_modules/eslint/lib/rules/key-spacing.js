...
module.exports = {
    ...
    create(context) {
        ...
        /**
         * Creates usergroups of properties.
        ...
        function createGroups(node) {
            ...
            return node.properties.reduce((usergroups, property) => {
                const currentGroup = last(usergroups),
                    prev = last(currentGroup);

                if (!prev || continuesPropertyGroup(prev, property)) {
                    currentGroup.push(property);
                } else {
                    usergroups.push([property]);
                }
        ...
        /**
         * Verifies vertical alignment, taking into account usergroups of properties.
         * @param  {ASTNode} node ObjectExpression node being evaluated.
         * @returns {void}
         */
