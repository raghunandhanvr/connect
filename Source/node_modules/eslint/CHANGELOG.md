...
* Update: key-spacing usergroups must be consecutive lines (fixes #1728) (Brandon Mills)
...
* Fix: Allow comments in key-spacing usergroups (fixes #1632) (Brandon Mills)
...
* Update: allow distinct alignment usergroups in key-spacing (fixes #1439) (Brandon Mills)
...
* Slight reorganization of rule usergroups (Nicholas C. Zakas)
